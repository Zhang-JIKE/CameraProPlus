package com.jike.cameraproplus.enhance;

import com.jike.cameraproplus.utils.ColorBalance;
...
*/
	public static void imgEnhance() {
		String imgPath = "sdcard/1.jpg";
		...
		Imgcodecs.imwrite("sdcard/2.jpg",fusion);
	}
